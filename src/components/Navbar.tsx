        ...
        <>
            <div className="w-full bg-white border-t max-w-[1300px] mx-auto border-purple-200 py-2 px-4 flex justify-between items-center text-purple-400 text-sm">
                <div className="flex items-center space-x-2">
                    ...
                    <a href="mailto:support@taseer.app" className="hover:underline">support@taseer.app</a>
                </div>
                <div className="flex space-x-4">
                    <a href="https://www.instagram.com/taseer.app"><FaInstagram size={20} className="cursor-pointer hover:text-purple-600" /></a>
                    <a href="https://www.linkedin.com/company/ta-seer/"><FaLinkedin size={20} className="cursor-pointer hover:text-purple-600" /></a>
                    <a href="https://medium.com/@taseeruae"><FaMedium size={20} className="cursor-pointer hover:text-purple-600" /></a>
                    <a href="https://www.facebook.com/share/4PjmQnUt2UveNf64/"><FaFacebook size={20} className="cursor-pointer hover:text-purple-600" /></a>
                    <a href="https://www.tiktok.com/@taseer727"><FaTiktok size={20} className="cursor-pointer hover:text-purple-600" /></a>
                    <a href="https://www.youtube.com/channel/UCZqNy4u25KYdB90gA0WG0VA"><FaYoutube size={20} className="cursor-pointer hover:text-purple-600" /></a>
                </div>
            </div>

            {/* Navbar */}
            <motion.header
                className={`fixed left-0 w-full shadow-md z-50 transition-all bg text-white  duration-300 ${scrolled ? " py-3 shadow-lg" : " py-5"} ${isHomePage && !scrolled ? "top-12" : "top-0"}`}
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            >
                <div className="container mx-auto \ flex items-center justify-between px-6">
                    ...
                    <nav className="hidden md:flex space-x-8  font-medium">
                        ...
                        >
                            <motion.button onClick={() => router('/resources')} className="flex items-center gap-2 hover:text-gray-900 transition" whileHover={{ scale: 1.05 }}>
