            ...
            <div className="flex items-center justify-center min-h-screen px-4">
                <div className="flex flex-col items-center text-center w-full max-w-2xl">
                    ...
                    <div className="mt-6 flex flex-col gap-4 w-full max-w-[300px]">
                        <Button onClick={() => router('/signup/onboarding/brand')} className="w-full py-4 text-lg" variant="white">
                            I'm a Brand
                        </Button>
                        <Button onClick={() => onSelected()} className="w-full py-4 text-lg" variant="white">
                            I'm a Creator
                        </Button>
                    </div>
                </div>
