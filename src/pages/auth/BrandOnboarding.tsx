        ...
        <div className="w-full max-w-md text-center">
          ...
          <div className="flex justify-between items-center mb-6">
            {Array.from({ length: totalSteps }, (_, i) => i + 1).map((num) => (
              <div
                key={num}
                className={`w-8 h-8 flex items-center justify-center rounded-full text-white font-semibold text-xs transition ${
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  {errors.representativeDepartment && (
                    <p className="text-red-500 text-sm mt-1">
                      {errors.representativeDepartment.message}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <div key={option.value} className="flex items-center">
                        <input
                          {...register("annualMarketingBudget", {
                  ...
                  {errors.annualMarketingBudget && (
                    <p className="text-red-500 text-sm mt-1">
                      {errors.annualMarketingBudget.message}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center">
                      <input
                        {...register("workedWithCreatorsBefore", {
                  ...
                  {errors.workedWithCreatorsBefore && (
                    <p className="text-red-500 text-sm mt-1">
                      {errors.workedWithCreatorsBefore.message}
                    </p>
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {[
                    {
                      value: "full_support",
                      label: "We need everything from strategy to execution",
                    },
                    {
                      value: "find_creators",
                      label:
                        "We want to find and collaborate with creators independently",
                    },
                    {
                      value: "campaign_management",
                      label: "We need help managing campaigns",
                    },
                    { value: "not_sure", label: "I am not sure" },
                  ].map((option) => (
                    <div key={option.value} className="flex items-center">
                      <input
                        {...register("expectationsFromUs", {
                          required: "Please select a support option",
                        })}
                        type="radio"
                        id={option.value}
                        value={option.value}
                ...
                {errors.expectationsFromUs && (
                  <p className="text-red-500 text-sm mt-1">
                    {errors.expectationsFromUs.message}
                  </p>
                )}
              </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center">
                    <input
                      ...
                      className="mr-3 h-5 w-5 accent-purple-600"
                    />
                    <label htmlFor="self_use" className="text-gray-700">
                      I'll use it myself
                    </label>
                  </div>
                  <div className="flex items-center">
                    <input
                      ...
                      className="mr-3 h-5 w-5 accent-purple-600"
                    />
                    <label htmlFor="training" className="text-gray-700">
                      I need a training session to use it better
                    </label>
                  </div>
                </div>
                {errors.platformUsagePlan && (
                  <p className="text-red-500 text-sm mt-1">
                    {errors.platformUsagePlan.message}
                  </p>
                )}
              </div>
              <div className="flex justify-between">
          ...
          {step === 6 && (
            <div className="space-y-5">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-gray-700 mb-1">
                    Which type of creator are you looking for? *
                  </label>
                  <div className="space-y-2">
                    {[
                      {
                        value: "freelancer",
                        label: "Freelancer Creator (Business account posts)",
                      },
                      {
                        value: "ugc",
                        label: "UGC Creator (Authentic user-generated content)",
                      },
                      ...
                      <div key={option.value} className="flex items-center">
                        <input
                          {...register("lookingForCreatorType", {
                  ...
                  {errors.lookingForCreatorType && (
                    <p className="text-red-500 text-sm mt-1">
                      {errors.lookingForCreatorType.message}
                    </p>
                  )}
                </div>
                    ...
                    {[
                      ...
                      <div key={platform.name} className="flex items-center">
                        <input
                          {...register(
                            `focusPlatforms.${
                              platform.name as keyof OnboardingFormData["focusPlatforms"]
                            }`
                          )}
                          type="checkbox"
                          id={platform.name}
