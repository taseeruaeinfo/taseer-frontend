...
export default function GigDetails() {
    ...
    useEffect(() => {
        const fetchCampaign = async (): Promise<void> => {
            ...
            try {
                setLoading(true);
                const response = await axios.get<Campaign>(`https://api.taseer.app/api/campaign/${campaignId}`, {
                    headers: {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
        ...
        try {
            const token = Cookies.get("jwt")
            setSubmitting(true);
            await axios.post(`https://api.taseer.app/api/campaigns/${campaignId}/apply`, formData, {
                headers: {
                    authorization: `Bearer ${token}`,
                }
            });
            ...
            <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <div className="md:col-span-2 space-y-8">
                    <div>
                        ...
                        <div className="flex hidden justify-end w-full mb-8">
                            <button
                                type="button"
