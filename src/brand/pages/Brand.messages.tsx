...
import { FiSend, FiPaperclip, FiSearch, FiChevronDown, FiX, FiMail, FiPhone, FiHome, FiFileText, FiCheckCircle } from "react-icons/fi";
...
type AttachmentType = "Image" | "Video" | "Document" | "Audio" | "Poll" | "Contact";
...
export default function BrandsMessagesPage() {
    ...
    const handleSendContract = () => {
        ...
        const requiredFields = ["deliverables", "platform", "contentFormat", "deadline", "budget"] as const;
        const missingFields = requiredFields.filter(field => !contractDetails[field]);
    ...
    const getStageColor = (stage: StageType): string => {
        switch (stage) {
            ...
            case "Content in Progress": return "bg-yellow-100 text-yellow-800";
            case "Approved for Posting": return "bg-green-100 text-green-800";
            case "Live": return "bg-purple-100 text-purple-800";
            case "Analytics Submitted": return "bg-indigo-100 text-indigo-800";
            case "Payment Pending": return "bg-orange-100 text-orange-800";
            case "Cancelled / Dropped": return "bg-red-100 text-red-800";
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="flex justify-between items-center">
                                            ...
                                            <span className={`text-xs px-2 py-0.5 rounded-full ${getStageColor(user.stage)}`}>
                                                {user.stage}
                                            </span>
                                        </div>
                                    </div>
                                            ...
                                            <div className="absolute right-0 mt-1 bg-white border rounded-lg shadow-lg w-48 z-10">
                                                <ul>
                                                    ...
                                                    >
                                                        ...
                                                        {selectedUser.isPremium && selectedUser.contactInfo.email && (
                                                    ...
                                                    >
                                                        ...
                                                        {selectedUser.isPremium && selectedUser.contactInfo.phone && (
                                                            <FiCheckCircle className="ml-auto text-green-500" />
                                                        )}
                                                    </li>
                                                    <li
                                                        className="px-4 py-2 hover:bg-gray-100 cursor-pointer flex items-center"
                                                        onClick={() => handleRequestInfo("Shipping Address")}
                                                    >
                                                        <FiHome className="mr-2" /> Shipping Address
                                                        {selectedUser.isPremium && selectedUser.contactInfo.address && (
                                                            <FiCheckCircle className="ml-auto text-green-500" />
                                                        )}
                                                    </li>
                                                </ul>
                                                    ...
                                                    {stageOptions.map(stage => (
                                                        <li
                                                            ...
                                                            className={clsx(
                                                                ...
                                                                selectedUser.stage === stage && "font-medium bg-gray-50"
                                                            )}
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            onChange={(e) => setContractDetails({ ...contractDetails, platform: e.target.value })}
                                        >
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            onChange={(e) => setContractDetails({ ...contractDetails, contentFormat: e.target.value })}
                                        >
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setContractDetails({ ...contractDetails, postingDate: e.target.value })}
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setContractDetails({ ...contractDetails, budget: e.target.value })}
                                        />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">Payment Split</label>
                                        <select
                                            className="w-full p-2 border rounded"
                                            value={contractDetails.paymentSplit}
                                            onChange={(e) => setContractDetails({ ...contractDetails, paymentSplit: e.target.value })}
                                        >
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            onChange={(e) => setContractDetails({ ...contractDetails, paymentMode: e.target.value })}
                                        >
                            ...
                            {showAttachments && (
                                <div className="bg-white border rounded-lg shadow-lg p-2 mb-2">
                                    <div className="grid grid-cols-3 gap-2">
                                        {(["Image", "Video", "Document", "Audio", "Poll", "Contact"] as AttachmentType[]).map((type) => (
                                            <button
                                                key={type}
